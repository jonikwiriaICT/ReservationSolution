<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChatHistory.aspx.cs" Inherits="Cust_ChatHistory" ValidateRequest ="true"  %>
...
<head>
    ...
    <title>Reserve and Service system</title>
        ...
        <div class="wrapper layout-top-nav">
                ...
                <nav class="navbar navbar-static-top">
                    <div class="container">
                        <div class="navbar-header">
                            <a href="index" class="navbar-brand"><b>Reserve</b>&nbsp System</a>
                        ...
                        <div class="row">
                            <div class="box box-success direct-chat direct-chat-success">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Reserve Chatbot</h3>
            ...
            <footer class="main-footer">
                ...
                <div class="container">
                    ...
                    <strong>Copyright &copy; <%=DateTime .UtcNow .Year  %> <a href="https://veritas.edu.ng">Designed by INT Isaac | Department of Computer and Information Technology.</a>.</strong> All rights
                            reserved.
                </div>
                <!-- /.container -->
            </footer>

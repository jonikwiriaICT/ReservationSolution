<%@ Page Title="" Language="C#" MasterPageFile="~/CustomerMasterPage.master" AutoEventWireup="true" CodeFile="MyCustomer.aspx.cs" Inherits="Cust_MyCustomer" ValidateRequest="false" %>
                            ...
                            <div class="panel-heading ">
                                <div class="panel-title ">
                                    ...
                                    <div class="btn-group pull-right ">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li>
                                                <asp:LinkButton ID="LinkButton1" Visible ="false"  OnClick="AddNewRecordClicked" runat="server"><i class=" fa fa-plus-circle"></i>Add New Record</asp:LinkButton>

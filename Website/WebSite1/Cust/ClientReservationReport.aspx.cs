...
public partial class Cust_ClientReservationReport : System.Web.UI.Page
{
    ...
    {
        TableResult.DataSource = objAdm.PopulateData(currentPage, "GetReservationbyID", int.Parse ( UserID ()));

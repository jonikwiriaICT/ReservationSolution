<%@ Page Title="" Language="C#" MasterPageFile="~/AdminReservationMaster.master" AutoEventWireup="true" CodeFile="RoomType.aspx.cs" Inherits="Administrator_RoomType" ValidateRequest="false" %>
                        ...
                        <div class="panel-body">
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    ...
                                    <br />
                                    <br />
                                    <asp:Panel ID="PnlRoomType" runat="server">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox ID="room_type" CssClass="form-control " runat="server"></asp:TextBox>

<%@ Page Title="" Language="C#" MasterPageFile="~/AdminReservationMaster.master" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="Administrator_ChangePassword" ValidateRequest="false" %>
                            ...
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    ...
                                    <asp:Panel ID="PnlCurrency" runat="server">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <asp:LinkButton ID="lnkSaveChanges" OnClick="ChangePasswordClicked" CssClass="btn btn-sm btn-primary pull-right  " runat="server"><i class="fa fa-save "></i>&nbsp Change Password</asp:LinkButton>
                                            </div>
                                        </div>
                                    </asp:Panel>
                                </div>

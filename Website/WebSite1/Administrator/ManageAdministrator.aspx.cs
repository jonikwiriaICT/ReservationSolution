...
public partial class Administrator_ManageAdministrator : System.Web.UI.Page
{
    ...
    protected void SaveChangesClicked(object sender, EventArgs e)
    {
        try
        {
            if (itrig == 0)
            {
                if (objAdm.CRUDAdministrator(rec_id.Value, fullname.Text, email.Text, telephone_no.Text, username.Text, userpassword.Text, "INSERT") == true)
                {
                    LoadGrid();
            ...
            if (itrig == 1)
            {
                ...
                if (objAdm.CRUDAdministrator(rec_id.Value, fullname.Text, email.Text, telephone_no.Text, username.Text, userpassword.Text, "UPDATE") == true)
                {
                    LoadGrid();
                    DisplaySuccess(objAdm.ErrorMessage);

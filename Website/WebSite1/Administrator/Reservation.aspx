<%@ Page Title="" Language="C#" MasterPageFile="~/AdminReservationMaster.master" AutoEventWireup="true" CodeFile="Reservation.aspx.cs" Inherits="Administrator_Reservation" ValidateRequest="false" %>
                            ...
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    ...
                                    <asp:Panel ID="PnlReservation" runat="server">
                                        ...
                                        <asp:HiddenField ID="booking_time" runat="server" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <asp:DropDownList ID="customer_id" CssClass="form-control" runat="server"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-9">
                                                <asp:DropDownList ID="room_id" CssClass="form-control" runat="server"></asp:DropDownList>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox ID="booking_date" CssClass="form-control " runat="server" placeholder="yyyy/mm/dd"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Expired Date</label>
                                            </div>
                                            <div class="col-md-9">
                                                <asp:TextBox ID="expired_date" CssClass="form-control " runat="server" placeholder="yyyy/mm/dd"></asp:TextBox>
                                            </div>
                                        </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/AdminReservationMaster.master" AutoEventWireup="true" CodeFile="ManageBookedRoom.aspx.cs" Inherits="Administrator_ManageBookedRoom" ValidateRequest="false" %>
                                            ...
                                            <asp:GridView ID="TableResult" runat="server" Font-Size="10px"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderStyle-Width="7%" HeaderText="Delete Record" Visible="true" HeaderStyle-CssClass=" thead-default" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbDelete" runat="server" Font-Size="14px" CssClass="btn btn-sm btn-info"
                                                                CausesValidation="False" CommandName="Delete" CommandArgument='<%# Container.DataItemIndex %>'>
                                                 Open Room for Booking   <i class="fa fa-edit"></i>
                                                            </asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabels">Open Room Record</h5>
                ...
                <div class="modal-footer bg-whitesmoke br">
                    ...
                    <asp:LinkButton ID="lnkDelete" CssClass="btn btn-sm btn-danger" OnClick="lbDeleteYes_Click" runat="server"><i class="fa fa-edit"></i>&nbsp Open Room</asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
